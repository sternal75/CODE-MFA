% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% Correlation between measured enzyme abundance in HeLa44 (x-axis) 
% and most probable net fluxes (y-axis) derived by CODE-MFA
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
...
[dEnzymes,tEnzymes] = xlsread('../xls_input_files/enzyme_concentrations.xlsx','enzymes');
...
title(sprintf('Best fit flux vs enzyme abundance: RHO=%f, PVAL=%e',RHO1,PVAL1));
%title(sprintf('Best fit flux vs gene expresssion: R=%f, P=%e',R1(1,2),P1(1,2)));
xlabel('Enzyme abundance [log10(PPM)]');
...
text_position(:,1) = [log10(enzyme_gene_expression(1))-0.03 log10(mean_fluxes(1))+0.09];
text_position(:,3) = [log10(enzyme_gene_expression(3))-0.03 log10(mean_fluxes(3))+0.09];
text_position(:,5) = [log10(enzyme_gene_expression(5))-0.03 log10(mean_fluxes(5))+0.09];
text_position(:,7) = [log10(enzyme_gene_expression(7))-0.08 log10(mean_fluxes(7))+0.09];
text_position(:,10) = [log10(enzyme_gene_expression(10))-0.03 log10(mean_fluxes(10))+0.09];
text_position(:,11) = [log10(enzyme_gene_expression(11))-0.1 log10(mean_fluxes(11))-0.09];
text_position(:,12) = [log10(enzyme_gene_expression(12))-0.03 log10(mean_fluxes(12))+0.09];
text_position(:,15) = [log10(enzyme_gene_expression(15))-0.03 log10(mean_fluxes(15))+0.09];
text_position(:,17) = [log10(enzyme_gene_expression(17))-0.03 log10(mean_fluxes(17))+0.09];
...
xlabel('Enzyme abundance [log10(fmol)]');
...
s = sprintf('./output_images/s2a.pdf');
saveas(gcf, s);
...
set(gcf,'PaperSize',[50 30]);
s = sprintf('./output_images/s2b.pdf');
saveas(gcf, s);
